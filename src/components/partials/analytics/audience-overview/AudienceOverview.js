        ...
        <div className="analytic-data-group analytic-ov-group g-3">
          <div className="analytic-data analytic-ov-data">
            ...
            <div className="change up">
              <Icon name="arrow-long-up"/> {auOverview === "month-1" ? "12.31" : "5.21"}%
            </div>
          </div>
          <div className="analytic-data analytic-ov-data">
            ...
            <div className="change up">
              <Icon name="arrow-long-up"/> {auOverview === "month-1" ? "47.5" : "80.6"}%
            </div>
          </div>
          <div className="analytic-data analytic-ov-data">
            <div className="title">Users</div>
            ...
            <div className="change down">
              <Icon name="arrow-long-down"/> {auOverview === "month-1" ? "12.57" : "18.21"}%
            </div>
          </div>
          <div className="analytic-data analytic-ov-data">
            <div className="title">Users</div>
            ...
            <div className="change down">
              <Icon name="arrow-long-down"/> {auOverview === "month-1" ? "0.35" : "1.21"}%
            </div>
          </div>
        </div>
