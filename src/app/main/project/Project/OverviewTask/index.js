...
import { Avatar, Badge, Divider, Dropdown, Menu, Slider, Spin, Tooltip } from 'antd';
		...
		<div className="container projects">
			...
			<div className="projects__content mt-8">
				<Spin spinning={actionLoading}>
					<Grid item container spacing={8} className="px-20">
						<Grid container item spacing={2} md={6} lg={6} className="content__overview">
