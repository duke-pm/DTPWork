...
export default function RequestResovelTable(props) {
	...
	useEffect(() => {
		dispatch(action.fetchDataConfirms(0, rowPage, page, search, dateStart, dateEnd, 1, true));
	}, [dispatch]);
			...
			<div className="w-full flex flex-col">
				<FuseScrollbars className="flex-grow overflow-x-auto">
					...
					<Table stickyHeader className="min-w-xl" aria-labelledby="tableTitle">
						...
						<BodyTableResovle classes={classes} entities={entities} lastErrors={lastErrors} />
