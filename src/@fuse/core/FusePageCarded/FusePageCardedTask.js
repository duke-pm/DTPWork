...
const FusePageCardedTask = React.forwardRef((props, ref) => {
...
FusePageCardedTask.propTypes = {
	...
	formProject: PropTypes.bool
};

FusePageCardedTask.defaultProps = {};

export default React.memo(FusePageCardedTask);
